...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!cookie) {
      console.error('[Roblox Image] No cookie configured');
    ...
    if (!assetRes.ok) {
      console.error('[Roblox Image] Asset fetch failed:', assetRes.status, assetRes.statusText);
    ...
    console.log('[Roblox Image] Content-Type:', contentType);
